 ...
 * @author giovanic
 */
public class VistaFigura extends javax.swing.JDialog {

    /**
     * Creates new form VistaFigura
     */
    public VistaFigura(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        JPanel principal = new JPanel(null);
        principal.setSize(WIDTH, HEIGHT);
        Figura cuadrado = new Cuadrado("cuadrado", 100, 100, 400, ColorEnum.NEGRO);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                VistaFigura dialog = new VistaFigura(new javax.swing.JFrame(), true);
