...
public class Practica1Compiladores {
     ...
     * System.out.println("\n\n");
     * String texto = """
     * graficar poligono ( PoligA, 100+(2.3-2)*12 + 2 -1/12,100+ 15, 6, 50 + 50 / 2,
     * 38 + 12, amarillo)
     * graficar circulo ( cir_Uno, 15, 6, 5 * 2 -1/12-(1.5*3), azul)
     * animar objeto anterior (curva, 50*3-4, 75+ 15/5, 2-1)
     * 
     * graficar rectangulo (RectAngulo_test_1, 12 * 3 + 2 (100), 2*60.50, 16 / 4,
     * rojo)
     ...
     * graficar cuadrado ( figura_cuadrada, 12*3+200, 15+1+300, (15-3) / 4+1.8+0.2,
     * verde)
